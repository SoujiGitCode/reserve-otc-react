            ...
            <div className="deznav">
                <PerfectScrollbar className="deznav-scroll">
                    <MM className="metismenu" id="menu">
                        <li className={`${dashboard.includes(path) ? "mm-active" : ""}`} id={"test"}>
                            ...
                            <ul>
                                <li>
                                    <Link className={`${path === "dashbiard" ? "mm-active" : ""}`} to="/dashboard"
                        ...
                        <li className={`${market.includes(path) ? "mm-active" : ""} ${level !== "2" ? "allfinNone" : null}`}>
                            <Link className="has-arrow ai-icon" to="#">
